...
class GridThing():
    ...
    def function_val(self, greens_function, greens_laplace, function):
        ...
        varience_at_boundry = boundry_varience * boundry_and_greens**2
        
        varience_potentials = potential_and_greens**2 * self.varience_walks
...
# walk_number = 3000
# start_value = np.array([5e-2, 3e-2]) # in the centre

# a = GridThing(n_value, boundry_value, interval)
# boundrys_c(a, n_value)
# a.intergrator(function_b)
