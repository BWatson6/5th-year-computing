...
class gridthing():
    ...
    def walker_vesion2(self, walk_numb, start_value):
        ...
        for i in range (0, walk_numb):
            ...
            global_counts_squared[1:self.N+1,1:self.N+1] += (h**2*walker_counts[1:self.N+1,1:self.N+1]*0.25)**2
...
point_of_interest = np.array([5, 5]) # now as spacial coordinate
